...
<!-- wp:post-excerpt {"moreText":"<?php echo esc_attr__( 'Read more →', 'terravan' ); ?>","excerptLength":20,"style":{"spacing":{"margin":{"bottom":"0","top":"var:preset|spacing|30"}}},"fontSize":"small"} /--></div>
<!-- /wp:group -->
<!-- /wp:post-template -->
