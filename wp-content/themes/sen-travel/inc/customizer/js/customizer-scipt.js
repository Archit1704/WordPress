...
( function( $, api ) {
    ...
    api.controlConstructor['sen-travel-repeater-text'] = api.Control.extend({
        ...
        // upsell 
    api.sectionConstructor['sen-travel-upsell'] = api.Section.extend( {
    ...
    wp.customize.bind('ready', function() {
         ...
         // Sortable sections
        jQuery( 'ul.sen-travel-sortable-list' ).sortable({
            handle: '.sen-travel-drag-handle',
            axis: 'y',
            update: function( e, ui ){
                jQuery('input.sen-travel-sortable-input').trigger( 'change' );
            }
        });

        // Sortable sections
        jQuery( "body" ).on( 'hover', '.sen-travel-drag-handle', function() {
            jQuery( 'ul.sen-travel-sortable-list' ).sortable({
                handle: '.sen-travel-drag-handle',
                axis: 'y',
                update: function( e, ui ){
        ...
        jQuery( "body" ).on( 'change', 'input.sen-travel-sortable-input', function() {
            /* Get the value, and convert to string. */
            this_checkboxes_values = jQuery( this ).parents( 'ul.sen-travel-sortable-list' ).find( 'input.sen-travel-sortable-input' ).map( function() {
                return this.value;
            }).get().join( ',' );

            /* Add the value to hidden input. */
            jQuery( this ).parents( 'ul.sen-travel-sortable-list' ).find( 'input.sen-travel-sortable-value' ).val( this_checkboxes_values ).trigger( 'change' );

        });

        // Deep linking for counter section to about section.
        jQuery('.sen-travel-edit').click(function(e) {
            e.preventDefault();
...
*/
 jQuery(document).ready(function($) {
    // $('#sen-travel-img-container li label img').click(function(){       
    //     $('#sen-travel-img-container li').each(function(){
    //         $(this).find('img').removeClass ('sen-travel-radio-img-selected') ;
    //     });
    //     $(this).addClass ('sen-travel-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', sen_travel_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', sen_travel_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', sen_travel_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #sen-travel-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #sen-travel-img-container li').each(function(){
            $(this).find('img').removeClass ('sen-travel-radio-img-selected') ;
        });
        $(this).addClass ('sen-travel-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #sen-travel-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #sen-travel-img-container li').each(function(){
            $(this).find('img').removeClass ('sen-travel-radio-img-selected') ;
        });
        $(this).addClass ('sen-travel-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #sen-travel-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #sen-travel-img-container li').each(function(){
            $(this).find('img').removeClass ('sen-travel-radio-img-selected') ;
        });
        $(this).addClass ('sen-travel-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #sen-travel-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #sen-travel-img-container li').each(function(){
            $(this).find('img').removeClass ('sen-travel-radio-img-selected') ;
        });
        $(this).addClass ('sen-travel-radio-img-selected') ;
    });    

    function sen_travel_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            sen_travel_customize_multi_write( $control );
    }

    function sen_travel_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        sen_travel_customize_multi_write( $control );
    }

    function sen_travel_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function sen_travel_customize_multi_write( $element) {
