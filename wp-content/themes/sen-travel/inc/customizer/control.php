...
class Sen_Travel_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="sen-travel-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Sen_Travel_Dropdown_Multiple_Chooser extends WP_Customize_Control{
    ...
    public function render_content(){
        ...
        ?>
            <label>
                ...
                <select class="sen-travel-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
...
Class Sen_Travel_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Sen_Travel_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Sen_Travel_Note_Control extends WP_Customize_Control {
