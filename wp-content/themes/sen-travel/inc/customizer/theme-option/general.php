...
'title'       => __('Sidebar Setting', 'sen-travel'),
...
$wp_customize->add_control( new Sen_Travel_Switch_Control( $wp_customize, 'theme_options[disable_homepage_content_section]',
    array(
		'label' 			=> __('Enable/Disable Static Homepage Content Section', 'sen-travel'),
		'description' => __('This option is only work on Static HomePage ', 'sen-travel'),
...
$wp_customize->add_control(new Sen_Travel_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Layout Option For Blog', 'sen-travel'),
...
$wp_customize->add_control(new Sen_Travel_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Layout Option For Archive', 'sen-travel'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new Sen_Travel_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Layout Option For Pages', 'sen-travel'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new Sen_Travel_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Layout Option For Single Posts', 'sen-travel'),
	'section' 	=> 'section_general',
